...
Paths below are each tool's **primary** install locations. Many tools also scan shared fallbacks such as `.agents/skills/` or `.claude/skills/`.
...
| [Codex](https://developers.openai.com/codex/skills)                                                            | `.agents/skills/claude-android-ninja/` (repo / CWD) | `~/.agents/skills/claude-android-ninja/`             | [Agent Skills](https://developers.openai.com/codex/skills)                                              |
