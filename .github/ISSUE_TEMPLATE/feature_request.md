...
about: Suggest a best practice, pattern, or topic to add to this SKILL
title: '[FEATURE] '
labels: enhancement
assignees: ''
---
...
**Example:**
"This relates to `references/architecture.md` and would fit well in the data layer section."
